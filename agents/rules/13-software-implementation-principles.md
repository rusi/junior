...
- ❌ **FORBIDDEN:** Try-catch wrapping everything with logging instead of fixing
- ❌ **FORBIDDEN:** Logging errors instead of taking action
...
- ✅ **REQUIRED:** Signal handlers MUST take action, not just log
...
- Check for evidence in logs (process indicators, service markers, connection states)
